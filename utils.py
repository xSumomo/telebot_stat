...
async def top5(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if top_users:
        ...
        for i, (user_id, username, first_name, last_name, total_messages, total_experience) in enumerate(top_users, start=1):
            ...
            if user_id == top_user_id:
                ...
                user_display_name = "🥉 " + user_display_name
            response += f"{i}. {user_display_name}: {total_messages} сообщений, {total_experience} опыта\n"
